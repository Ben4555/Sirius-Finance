...
<div class='menu-con-container'>
	...
	<div class="menu-con-outer">
		<div class="menu-con-inner">
			...
			<a href='https://medium.com/@lowcryptoben' target="_blank">
			...
			<a href='https://discord.gg/haGZe9Wx' target="_blank">
			<div class="menu-btn-select">
				<span>Discord</span>
			</div>
			</a>
			<a href='https://twitter.com/Sirius_Finance' target="_blank">
			<div class="menu-btn-select">
				<span>Twitter</span>
			</div>
			</a>
			...
			<a href='https://medium.com/@siriusfinance' target="_blank">
			<div class="menu-btn-select">
				<span>Medium</span>
			</div>
			</a>
